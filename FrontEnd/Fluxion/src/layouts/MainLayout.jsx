  ...
  return (
    <div className="ml-shell">
      ...
      <aside className="ml-sidebar">
        ...
        {/* Logo */}
        <div className="ml-sb-logo">
          <div className="ml-sb-mark">
            <svg viewBox="0 0 14 14"><rect x="1" y="1" width="5" height="5" rx="1" fill="white"/><rect x="8" y="1" width="5" height="5" rx="1" fill="white"/><rect x="1" y="8" width="5" height="5" rx="1" fill="white"/><rect x="8" y="8" width="5" height="5" rx="1" fill="white"/></svg>
          </div>
          <span className="ml-sb-wordmark">FLUXION</span>
        </div>
