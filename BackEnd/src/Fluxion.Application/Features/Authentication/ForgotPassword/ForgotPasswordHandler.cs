...
public class ForgotPasswordHandler : IRequestHandler<ForgotPasswordCommand, ForgotPasswordResponse>
{
    ...
    public async Task<ForgotPasswordResponse> Handle(ForgotPasswordCommand request, CancellationToken cancellationToken)
    {
        ...
        if (user is null)
        {
            ...
            return new ForgotPasswordResponse(true, "If an account with that email exists, a verification code has been sent.");
        }
    ...
    <tr>
      <td align=""center"">
        <table role=""presentation"" width=""480"" cellpadding=""0"" cellspacing=""0"" style=""background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);"">
          ...
          <tr>
            <td style=""padding:40px 40px 20px;"">
              <h1 style=""margin:0 0 8px;font-size:22px;font-weight:700;color:#0D0D0D;letter-spacing:-0.02em;"">Reset your password</h1>
              <p style=""margin:0 0 28px;font-size:14px;color:#8A9BAD;line-height:1.6;"">
                We received a request to reset your Fluxion password. Enter the code below to continue.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style=""padding:24px 40px;text-align:center;"">
              <p style=""margin:0;font-size:11px;color:#8A9BAD;line-height:1.5;"">
                You received this email because a password reset was requested for your Fluxion account.
              ...
              <p style=""margin:12px 0 0;font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(138,155,173,0.6);"">
                &copy; {DateTime.UtcNow.Year} Fluxion &middot; Enterprise Asset Management
              </p>
            </td>
          </tr>
        ...
        await _emailService.SendEmailAsync(
            request.Email,
            $"Fluxion — Your password reset code is {code}",
            html
        );
